...
class HPPicker: NSObject {
    
    static let sharedInstance = HPPicker()
    ...
    class func selectDate(title: String = "",
        ...
        if let currentController = APPDELEGATE.window?.rootViewController {
            ...
            let toolBar = HPToolBar(frame: toolBarFrame)
...
extension HPPicker: UIPickerViewDataSource, UIPickerViewDelegate {
