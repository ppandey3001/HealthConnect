...
class AppTheme {
    ...
    class func applyAppearance() {
        ...
        UITabBar.appearance().barTintColor = UIColor.colorFromRGB(224.0, 224.0, 224.0) //bar background color
...
//        UITabBar.appearance().selectionIndicatorImage = UIColor.themePrimaryColor().image(w: 200.0, h:120.0).resizableImage(withCapInsets: .zero, resizingMode: .stretch)
        ...
        UITabBarItem.appearance().titlePositionAdjustment = UIOffset.init(horizontal: 0.0, vertical: 1.0)
    }
}
